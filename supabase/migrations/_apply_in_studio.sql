-- ============================================================================
-- ALL-IN-ONE SUPABASE STUDIO PASTE FILE
-- ============================================================================
-- Wygenerowane: maj 2026 dla brancha persona-audit-and-pwa.
--
-- Ten plik zawiera wszystkie 6 migracji w jednym kawałku, posegregowane
-- sekcjami. NIE jest podchwytywany przez supabase CLI (underscore prefix).
--
-- JAK UŻYĆ:
--   1. Otwórz Supabase Dashboard → swój projekt → SQL Editor
--   2. + New query
--   3. Wklej CAŁOŚĆ tego pliku (Ctrl+A, Ctrl+C tutaj → Ctrl+V tam)
...
--
-- WERYFIKACJA PO RUN:
--   select count(*) from public.exercises;             -- powinno być 39
--   select count(*) from public.badges;                -- powinno być 8
--   select column_name from information_schema.columns -- new fields:
--     where table_schema='public' and table_name='profiles'
--     and column_name in ('trains_with_partner','group_code');
--   select * from public.get_group_stats('TESTCODE');  -- (0, 0, 0)
-- ============================================================================
